...
DATABASES = {
    'default': {
        ...
        'NAME': 'pypoll',                      # Or path to database file if using sqlite3.
        'USER': 'pypoll',                      # Not used with sqlite3.
        'PASSWORD': 'pypoll',                  # Not used with sqlite3.
...
SECRET_KEY = 'ns=vk_l)tb7i$0zajd+dg%fnx=n&amp;@2i6&amp;fmrd@=^%1x^o^ib2n'
